...
declare
    cursor cur_tablas is
        ...
        or table_name in ('TI_PAGO_AUTO_F1','TI_PAGO_AUTO_F2','TI_PAGO_AUTO_F3',
            'TS_PAGO_AUTO_F1','TS_PAGO_AUTO_F2','TS_PAGO_AUTO_F3');
begin
...
Prompt tablas temporales para la tabla PAGO_AUTO_3
--Para operaciones INSERT
