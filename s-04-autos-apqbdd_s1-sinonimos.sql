...
create or replace synonym cliente_f2 for CLIENTE_F2_APQ_S1;
create or replace synonym historico_status_auto_f2 for HISTORICO_STATUS_AUTO_F2_APQ_S1;
create or replace synonym marca_r1 for MARCA_R_APQ_S1;
create or replace synonym modelo_r1 for MODELO_R_APQ_S1;
create or replace synonym pago_auto_f2 for PAGO_AUTO_F2_APQ_S1;
create or replace synonym sucursal_f1 for SUCURSAL_F1_APQ_S1;
create or replace synonym tarjeta_cliente_f1 for TARJETA_CLIENTE_F1_APQ_S1;
