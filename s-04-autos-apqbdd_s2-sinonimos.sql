...
prompt Creando sinonimos para fragmentos de Sitio 4 apqbdd_s2 local

create or replace synonym auto_1 for AUTO_F1_APQ_S2;
create or replace synonym cliente_3 for CLIENTE_F3_APQ_S2;
create or replace synonym historico_status_auto_1 for HISTORICO_STATUS_AUTO_F1_APQ_S2;
create or replace synonym marca_r2 for MARCA_R_APQ_S2;
create or replace synonym modelo_r2 for MODELO_R_APQ_S2;
create or replace synonym pago_auto_3 for PAGO_AUTO_F3_APQ_S2;


prompt Creando sinonimos de S4 para fragmentos de Sitio 3 apqbdd_s1 remoto
...
prompt Creando sinonimos de S4 para fragmentos de Sitio 1 maqbdd_s1 remoto
...
prompt Creando sinonimos de S4 para fragmentos de Sitio 2 maqbdd_s2 remoto
