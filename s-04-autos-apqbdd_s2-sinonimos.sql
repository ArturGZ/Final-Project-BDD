...
create or replace synonym auto_f1 for AUTO_F1_APQ_S2;
create or replace synonym cliente_f3 for CLIENTE_F3_APQ_S2;
create or replace synonym historico_status_auto_f1 for HISTORICO_STATUS_AUTO_F1_APQ_S2;
create or replace synonym marca_r1 for MARCA_R_APQ_S2;
create or replace synonym modelo_r1 for MODELO_R_APQ_S2;
create or replace synonym pago_auto_f3 for PAGO_AUTO_F3_APQ_S2;
...
create or replace synonym marca_r2 for MARCA_R_APQ_S1@apqbdd_s1;
create or replace synonym modelo_r2 for MODELO_R_APQ_S1@apqbdd_s1;
