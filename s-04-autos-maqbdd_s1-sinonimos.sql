...
create or replace synonym pais_1 for PAIS_F1_MAQ_S1;
create or replace synonym sucursal_2 for SUCURSAL_F2_MAQ_S1;
create or replace synonym marca_r3 for MARCA_R_MAQ_S1;
create or replace synonym modelo_r3 for MODELO_R_MAQ_S1;
create or replace synonym auto_2 for AUTO_F2_MAQ_S1;
create or replace synonym auto_carga_1 for AUTO_CARGA_F1_MAQ_S1;
create or replace synonym auto_particular_1 for AUTO_PARTICULAR_F1_MAQ_S1;
